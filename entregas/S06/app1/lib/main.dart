      ...
      home: Scaffold(
        body: ListView(
          ...
          children: [
            const Row(
              children: [
                Icon(Icons.menu, color: kLima),
                SizedBox(width: 8),
                Spacer(),
                Icon(Icons.notifications, color: kLima),
              ],
            ),
            ...
            const Column(
              ...
              children: [
                Row(
                  ...
                  children: [
                    Icon(Icons.wb_sunny, color: kLima, size: 52),
                    Text(
                      'Buenos Dias',
...
Widget detailListTile(
  ...
  return ListTile(
    ...
    trailing: Column(
      ...
      children: [
        Text(amount, style: const TextStyle(fontSize: 13, color: kTexto)),
